...
Datasets = {'PCMAC.mat','BASEHOCK.mat' };%'orlraws10P.mat','warpAR10P.mat','warpPIE10P.mat','PCMAC.mat','BASEHOCK.mat'};%%, 'GLI-85.mat', 'GLA-BRA-180.mat' CLL_SUB_111.mat smk
%Datasets = {'orlraws10P.mat','warpAR10P.mat','warpPIE10P.mat', 'pixraw10P.mat'};%%, 'GLI-85.mat', 'GLA-BRA-180.mat' CLL_SUB_111.mat smk
...
while length(irrelevantFeatures)>BufferSize
    NumberOfSelectedF = length(selectedF)
...
Accuracy = ClassifyNB([data(:,selectedF) , y]);
...
save(['results_NB_SFS_ReRanking\' cell2mat(DataName)],'Accuracy','NumberOfSelectedF','selectedF','newDATA','time1');
