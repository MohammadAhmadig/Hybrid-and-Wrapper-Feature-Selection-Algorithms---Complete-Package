function [ ACC,acc ] = IWSS_ClassifyNB( DATA ,CVO)
...
%     
    ...
    Train = DATA(trIdx,:);
    Test = DATA(teIdx,:);
    save train11.txt Train -ascii
    save test11.txt Test -ascii
    
    ArffTrain = convertToArff('train11.txt');
    ArffTest = convertToArff('test11.txt');
