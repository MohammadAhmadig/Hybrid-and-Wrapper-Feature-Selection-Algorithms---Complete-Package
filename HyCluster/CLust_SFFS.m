...
Datasets = { 'CLL_SUB_111.mat' , 'SMK_CAN_187.mat','TOX_171.mat'};%'orlraws10P.mat','warpAR10P.mat','warpPIE10P.mat','PCMAC.mat','BASEHOCK.mat'};%%, 'GLI-85.mat', 'GLA-BRA-180.mat' CLL_SUB_111.mat smk
...
save(['results_Spec_SFFS_myMethod_fold\'  cell2mat(DataName) ] ,'meanAcc','Accuracy','optK','NumberOfSelectedF','NumberOfSelectedFOrg','avgSizeClusters','selectedF','time1','clusters','OLDclusters','CVO','meanNumOfEval');
